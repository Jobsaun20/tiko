...
note: "• Amende : envoyée en cas de non-respect d’une règle.\n • Défi : défis temporaires proposés à un ou plusieurs contacts."
      ...
      phoneShare: {
        title: "Activer les paiements avec Bizum",
        description: "Pour recevoir des paiements via Bizum, ajoutez votre numéro de téléphone. PAS D’INQUIÉTUDE ! Seule la personne qui reçoit votre amende le verra.",
        addPhone: "Ajouter le numéro",
        skipNow: "Ignorer pour l’instant",
        shareApp: "Partager l’app / Inviter",
        phoneLabel: "Votre numéro (Bizum)",
