...
showInstallBanner: "Für die Installation auf iOS: Tippe auf „Teilen“ 📤 und wähle „Zum Home-Bildschirm hinzufügen“ aus.",
  ...
  description: "Erstellt CHFe Gruppe, legt CHFe Regeln fest, startet Herausforderungen… und keiner entkommt! Wer sich nicht an die Regeln hält, muss zahlen!",
  login: "Einloggen",
...
onboard: {
  ...
  createGroupsDescription: "Erstelle eine Gruppe mit deinem Partner, Freunden, Mitbewohnern oder Kollegen und definiert CHFe eigenen Regeln (Keine Haare in der Dusche, Kein Unterbrechen in Meetings...) und wenn sich jemand nicht daran hält, zahlt er!",
...
created: "erstellt",
  ...
  pages: {
    ...
    groups: {
      ...
      groupName: "Gruppenname",
      description: "Erstelle eine Gruppe, füge Mitglieder hinzu und legt CHFe Regeln fest.",
      members: "Mitglieder",
      admin: "Admin",
      member: "Mitglied",
      leave: "Verlassen",
