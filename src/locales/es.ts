...
notifications: {
  ...
  fine_received: {
    ...
    icon: "💸",
    message: '{{sender}} te ha enviado una multa de {{amount}} € por "{{reason}}"',
  },
  challenge_created: {
    title: "Reto creado",
    icon: "🏆",
  ...
  payment_received: {
    title: "Pago recibido",
    icon: "💰",
    message: "Has recibido un pago por {{amount}} € de {{sender}}",
  },
  group_invite: {
...
deletedRulePushBody: "La regla \"{rule}\" del grupo \"{group}\" fue eliminada.",
  ...
  phoneUpdatedDescription:"Ahora puedes recibir tus ganancias con Bizum",
...
challengeCard: {
  ...
  fineReceivedBody: "Has recibido una multa de  por {{amount}} €. Motivo: {{reason}}",
...
createGroupModal: {
  createGroup: "Crear nuevo grupo",
    ...
    errorNoQR: "Debes proporcionar el QR Bizum del grupo para el modo 'Pago al Admin'",
...
paymentModal: {
  title: "Pagar multa",
  description: "Copiando el numero del emisor y usalo para pagar en Bizum",
  fine: "Multa",
  amount: "Importe",
  sender: "Remitente",
  reason: "Motivo",
  scanQR: "Numero para Bizum",
  ...
  close: "Cerrar",
  noBizumNumber: "El remitente no ha configurado su número de Bizum",
  you:"tú",
  },
...
share: {
   title: "Comparte Tiko",
    ...
    buttonDesc: "Comparte Tiko con tus amigos",
...
banner: {
  ...
  phoneWarning: "Añade tu teléfono para recibir pagos con Bizum. ¡NO TE PREOCUPES! Solo quien reciba tu multa podrá verlo.",
  phoneWarningButton: "Añadir número",
},

welcome: {
  title: "Bienvenido a Tiko",
...
onboard: {
  whatIsTiko: "¿Qué es Tiko?",
  whatIsTikoDescription: "Tiko es la app que transforma la convivencia en un juego donde gana quien cumple y hace cumplir las reglas.",
  ...
  payAndLevelUpDescription: "El objetivo de Tiko es mejorar la convivencia, jugar en equipo, mejorar hábitos y divertirse en el proceso mientras te conviertes en EL COMPAÑERO PERFECTO",
  back: "Atrás",
  next: "Siguiente",
...
// History Page
  ...
  createFine: {
    ...
    sentTo: "Multa de {amount} € enviada a {recipient}",
  ...
  // Payment Modal
  payment: {
    title: "Pagar multa - {amount} €",
    description: "Paga tu multa usando Bizum escaneando el código QR o usando el número",
    details: "Detalles de la multa",
    reason: "Motivo:",
    sender: "Remitente:",
    amount: "Importe:",
    options: "Opciones de pago Bizum",
    scanQR: "Escanea con tu app Bizum",
    useNumber: "O usa el número Bizum:",
    copied: "Copiado",
    numberCopied: "Número de Bizum copiado al portapapeles",
  ...
  profile: {
    title: "Mi perfil",
    description: "Actualiza tu información personal y configura tu método de pago Bizum",
    changePhoto: "Cambiar foto",
    personalInfo: "Información personal",
    fullName: "Nombre completo",
    userName: "Nombre de Usuario",
    phone: "Teléfono",
    BizumConfig: "Configuración de Bizum",
    uploadQR: "Sube tu código QR de Bizum",
    ...
    BizumUploadDescription: "Función para subir QR próximamente",
  ...
  pages: {
    ...
    notifications: {
      ...
      fine_received: "{{sender}} te ha enviado una multa de {{amount}} € por \"{{reason}}\"",
      fine_received_title: "Multa recibida",
      payment_received: "{{sender}} ha pagado tu multa de {{amount}} €",
